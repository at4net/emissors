 ...
 * @author gdeignacio
 */
public class ECOT103Iv3ClientTest {


	private ECOT103Iv3Client client;

	public ECOT103Iv3ClientTest() {
	}
	...
	public void setUp() {
		...
		client = new ECOT103Iv3Client(app);
	...
	/**
	 * Test of dummy method, of class ECOT103Iv3Client.
	 */
	@Test
	...
	/**
	 * Test of peticionSincrona method, of class ECOT103Iv3Client.
	 */
	@Test
	public void testPeticionSincrona() {
		//System.out.println("peticionSincrona");

		RespuestaClientAdapter<ECOT103Iv3RespuestaDatosEspecificos> expResult = null;
		RespuestaClientAdapter<ECOT103Iv3RespuestaDatosEspecificos> result = client.peticionSincrona();

		System.out.println("APELLIDO  " + result.getTransmisionesClient().get(0).getDatosEspecificos().getObligacionesTributarias().getCodigoCertificado());
