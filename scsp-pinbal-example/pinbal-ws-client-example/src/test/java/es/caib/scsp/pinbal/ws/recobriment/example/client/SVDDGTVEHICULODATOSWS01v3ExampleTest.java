...
public class SVDDGTVEHICULODATOSWS01v3ExampleTest {
    ...
    public void testPeticionSincrona() {
        ...
        System.out.println("Test retorno corregido  " + result.getTransmisionesClient().get(0).getDatosEspecificos().getRetorno().getDatosVehiculo().getDatosGenerales().getDescripcionVehiculo().getBastidor());
